(module
  ...
  (func $_start (type 9)
    ...
    unreachable)
  (func $thread_routine (type 2) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i32 i32 i32 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
  ...
  (func $__original_main (type 8) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 0
    i32.const 48
    local.set 1
  ...
  (func $time (type 10) (param i32) (result i64)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $dlmalloc (type 2) (param i32) (result i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        i32.const 0
        i32.const 1
        i32.atomic.rmw.xchg offset=5700
        i32.eqz
        br_if 0 (;@2;)
        i32.const 1
        local.set 2
      ...
      block  ;; label = @2
        ...
        i32.const 0
        i64.const -1
        i64.store offset=5212 align=4
        i32.const 0
        i64.const 281474976776192
        i64.store offset=5204 align=4
        i32.const 0
        i64.const 2
        i64.store offset=5668 align=4
        i32.const 0
        local.get 1
        i32.const 4
        i32.add
      ...
      i32.const 0
      i32.const 0
      i32.atomic.store offset=5700
    end
    block  ;; label = @1
      i32.const 0
      i32.load8_u offset=5668
      i32.const 2
      i32.and
      i32.eqz
      br_if 0 (;@1;)
      i32.const 0
      i32.const 1
      i32.atomic.rmw.xchg offset=5672
      i32.eqz
      br_if 0 (;@1;)
      i32.const 1
      local.set 2
  ...
  (func $__tl_unlock (type 9)
    ...
    loop  ;; label = @1
      ...
      local.get 0
      i32.const 0
      i32.atomic.rmw.cmpxchg offset=4100
      i32.ne
      br_if 0 (;@1;)
    end
    block  ;; label = @1
      ...
      i32.const 0
      i32.const 1
      memory.atomic.notify offset=4100
      drop
    end)
  ...
  (func $__pthread_create (type 7) (param i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 9)
  (func $__pthread_self_internal (type 8) (result i32)
    global.get $__tls_base
    i32.const 4
    i32.add)
  ...
  (func $__udivti3 (type 18) (param i32 i64 i64 i64 i64)
    ...
    global.set $__stack_pointer)
  (table (;0;) 7 7 funcref)
  (global $__stack_pointer (mut i32) (i32.const 71264))
  ...
  (elem (;0;) (i32.const 1) func $thread_routine $__stdio_write $__stdio_close $__stdout_write $__stdio_seek $sn_write)
