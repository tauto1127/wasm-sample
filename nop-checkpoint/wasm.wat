(module
  ...
  (func $_start (type 9)
    ...
    unreachable)
  (func $worker (type 2) (param i32) (result i32)
  ...
  (func $__tl_unlock (type 9)
    ...
    loop  ;; label = @1
      ...
      local.get 0
      i32.const 0
      i32.atomic.rmw.cmpxchg offset=3900
      i32.ne
      br_if 0 (;@1;)
    end
    block  ;; label = @1
      ...
      i32.const 0
      i32.const 1
      memory.atomic.notify offset=3900
      drop
    end)
  ...
  (func $wasi_thread_start (type 16) (param i32 i32)
    ...
    drop)
  (table (;0;) 6 6 funcref)
  (global $__stack_pointer (mut i32) (i32.const 71072))
  ...
  (elem (;0;) (i32.const 1) func $worker $__stdio_write $__stdio_close $__stdout_write $__stdio_seek)
